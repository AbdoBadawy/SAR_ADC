...
C {devices/vsource.sym} -1350 700 0 0 {name=V6 value="sin(\{VDC\} \{2*VPK\} \{FIN\})" savecurrent=false}
...
C {devices/lab_pin.sym} -1470 670 1 0 {name=p27 sig_type=std_logic lab=VIN}
...
C {devices/noconn.sym} 450 100 2 0 {name=l14}
